...
import { ArrowLeft, Check, X, Undo2, Truck, ShoppingCart } from "lucide-react";
import {
...
export function DevolucionCompraDetalleClient({
  devolucion,
}: {
  devolucion: DevolucionCompraDTO;
}) {
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
          ...
          <p className="mt-1 font-semibold text-zinc-900 dark:text-zinc-50">
            {devolucion.proveedor_nombre ?? "—"}
          </p>
        </div>
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
          <p className="flex items-center gap-1.5 text-sm text-zinc-500 dark:text-zinc-400">
            <ShoppingCart className="h-4 w-4" /> Orden de compra
          </p>
          <p className="mt-1 font-mono text-sm font-semibold text-zinc-900 dark:text-zinc-50">
            {devolucion.orden_compra_numero ?? "—"}
          </p>
        </div>
        <div className="rounded-2xl border border-zinc-200 bg-white p-5 dark:border-zinc-800 dark:bg-zinc-950">
          <p className="flex items-center gap-1.5 text-sm text-zinc-500 dark:text-zinc-400">
