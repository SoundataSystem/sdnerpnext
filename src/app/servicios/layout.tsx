...
const NAV_ITEMS = [
  ...
  { href: "/servicios/ordenes", label: "Órdenes de Servicio" },
  { href: "/servicios/tecnicos", label: "Técnicos" },
  { href: "/servicios/instalaciones", label: "Instalaciones" },
  { href: "/servicios/garantias", label: "Garantías" },
  { href: "/servicios/tickets", label: "Soporte" },
  { href: "/servicios/rmas", label: "RMA" },
];
